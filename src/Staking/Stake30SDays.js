...
import { thirthyDaysstakingContractAddress } from '../AUTH/addresses';
...
const contract = thirthyDaysstakingContractAddress;



function Stake30Dyas() {
  ...
  if (data === null) {
    ...
    return <div>Loading V1 30 Days Stake Info...</div>;
  }
