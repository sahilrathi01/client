...
import { FourteenDaysstakingContractAddress } from '../AUTH/addresses';
...
const contract = FourteenDaysstakingContractAddress;



function Stake14Dyas() {
  ...
  if (data === null) {
    ...
    return <div>Loading V1 14 Days Stake Info...</div>;
  }
